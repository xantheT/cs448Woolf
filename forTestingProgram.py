...
randomArr = generateRandomText(additionalLazyArr[1])
print "********** _______RANDLINE_____*************"
...
print "done 2nd random generation one!"
...
print "***********_____NEXT TEXT_____************"
print str(randomArr[4])
print "done 3rd random generation one!"


#calling twice works!
additionalLazyArr = do_everything_and_give_me_the_RandomArr("woolf", filenameSplit, filenameSum)
print "********** _______RANDLINE_____*************"
print str(additionalLazyArr[0][0])
print "***********_____FROM TEXT_____************"
print str(additionalLazyArr[0][1])
...
additionalLazyArr = do_everything_and_give_me_the_RandomArr(query, filenameSplit, filenameSum)
print "********** _______RANDLINE_____*************"
print str(additionalLazyArr[0])
print "***********_____FROM TEXT_____************"
print str(additionalLazyArr[1])
print "***********_____DATE_____************"
print str(additionalLazyArr[2])
print "***********_____PREV TEXT_____************"
print str(additionalLazyArr[3])
print "***********_____NEXT TEXT_____************"
print str(additionalLazyArr[4])
print "done!"
